...
我是一名热爱开发的小白，有幸进入的一个充满蓬勃朝气的软件开发公司，怀里揣着做大事的信念，头破血流也不退缩的精神，从事着互联网软件开发的工作，为大数据的发展和崛起而奋斗。
...
- [Skeleton 模块化项目骨架开发文档](http://note.youdao.com/noteshare?id=081f915e3f39a2b7ed10f414772fafc7)
