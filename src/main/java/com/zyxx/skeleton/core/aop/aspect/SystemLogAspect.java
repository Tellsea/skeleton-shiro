...
import com.zyxx.skeleton.core.aop.annotation.SystemControllerLog;
import com.zyxx.skeleton.core.aop.annotation.SystemServiceLog;
...
public class SystemLogAspect {
     ...
     * Controller层切点
     */
    @Pointcut("@annotation(com.zyxx.skeleton.core.aop.annotation.SystemControllerLog)")
     ...
     * Service层切点
     */
    @Pointcut("@annotation(com.zyxx.skeleton.core.aop.annotation.SystemServiceLog)")
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        try {
            ...
            log.info("请求人：" + userInfo.getUserName());
            log.info("请求ip：" + ip);
